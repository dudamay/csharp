...
public abstract class Militar
{
    ...
    public Militar(string nome,int nivel,double pontuacao,double vida,double forca,double agilidade,double inteligencia,string[] armasEquipamentos)
    {
        this.nome = nome;
        this.nivel = nivel;
    ...
    public void UsarHabilidade(string habilidade,Militar alvo){
...
class Program{
    static void Main(string[] args){
        Sargento sargento = new Sargento("Marcely", 100,128,5,67,654,90,new string[] {"ak47", "fuzil", "metralhadora" });
            ...
            Cabo cabo = new Cabo("Amanda", 100,128,5,67,654,90,new string[] {"ak47", "fuzil", "metralhadora" });
